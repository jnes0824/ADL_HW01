...
def main():
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(active_dataloader):
            ...
            #     accelerator.log({"train_loss": total_loss.item() / (step + 1)}, step=completed_steps)
            #     # logger.info(f"Logging train loss: {total_loss.item() / (step + 1)}, step: {completed_steps}")
            ...
            if accelerator.sync_gradients:
                ...
                completed_steps += 1
                # Log training loss
                accelerator.log({"train_loss": total_loss.item() / completed_steps}, step=completed_steps)
        ...
        # accelerator.log({"eval_loss": avg_eval_loss.item()}, step=completed_steps)
        # log evaluation metrics
        accelerator.log(eval_metric, step=completed_steps)
        # logger.info(f"Evaluation metrics: {eval_metric}, Validation Loss: {avg_eval_loss.item()}")
        ...
        if args.with_tracking:
            log = {
                ...
                # "valid_loss": avg_eval_loss.item(),
                "epoch": epoch,
                "step": completed_steps,
                "exact_match": eval_metric["exact_match"],
            }
            accelerator.log(log, step=completed_steps)
            logger.info(f"Logging : log , step: {completed_steps}")
